---
title: "Systematic review of outbreak response models: data analysis"
...
source(file.path('orv_models_review_data_cleaning.R'))
```
...
compact_data_init <- read_rds(file.path(data_dir, "review_data_compact_cleaned.rds"))
...
compact_data_with_citation_keys_init <- read_rds(file.path(data_dir, "compact_data_with_citation_keys_cleaned.rds")) 
