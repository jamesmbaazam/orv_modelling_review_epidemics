...
knitr::kable(cols_1_to_6, 
  ...
  kableExtra::column_spec(column = c(2), width = "4cm") %>%
   kableExtra::column_spec(column = c(4), width = "3.5cm") %>% 
    kableExtra::column_spec(column = c(6), width = "1.5cm") %>% 
...
knitr::kable(cols_7_to_10, 
  ...
  kableExtra::column_spec(column = c(2, 4), width = "3.3cm") %>% 
kableExtra::column_spec(column = c(5), width = "2cm") %>% 
  kableExtra::landscape() 
```
## Table 3
...
knitr::kable(cols_11_to_14, 
  ...
  kableExtra::column_spec(column = c(2, 4), width = "3cm") %>% 
  kableExtra::landscape() 
```
## Table 4
...
knitr::kable(cols_15_to_16, 
  ...
  kableExtra::column_spec(column = c(2), width = "3cm") %>%
   kableExtra::column_spec(column = c(4), width = "8cm") %>%
  kableExtra::landscape() 
```
## Table 5
...
knitr::kable(cols_19_to_20, 
  ...
  kableExtra::column_spec(column = c(2), width = "4cm") %>%
  kableExtra::column_spec(column = c(3), width = "6cm") %>%
  kableExtra::landscape() 
```
...
knitr::kable(cols_21_to_22, 
  ...
  kableExtra::column_spec(column = c(2), width = "9cm") %>% 
  kableExtra::landscape() 
```
## Table 8
