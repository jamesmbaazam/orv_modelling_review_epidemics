...
here::i_am("analyses/scripts/orv_sys_rev_data_analysis.Rmd")
...
long_data <- read_rds(here::here(data_dir, "review_data_long_cleaned.rds"))

#The cleaned data without citations
compact_data_init <- read_rds(
  here::here(data_dir, "review_data_compact_cleaned.rds")
  )
