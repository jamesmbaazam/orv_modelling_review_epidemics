...
#directories
# Figures
figs_dir <- "../figs_manuscript"

# Create a folder for storing the manuscript figures if it doesn't exist
...
source("./orv_models_review_data_cleaning.R")

# Load the cleaned data 
long_data <- read_rds(file.path(data_dir, "review_data_long_cleaned.rds"))

#The cleaned data without citations
compact_data_init <- read_rds(file.path(data_dir, 
                                        "review_data_compact_cleaned.rds")
                              )
...
```{r}
# Dictionary of parametrization methods descriptions
